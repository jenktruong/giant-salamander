...
The salamanders of the OG and CC sections are unpaired, so we will do an unpaired t-test and the Mann-whitney U test to see if they are significantly different from each other.
