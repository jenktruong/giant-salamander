...
The F-statistic is `r weight_channel_anova$statistic` and the p-value is `r weight_schannel_anova$p.value`. We have sufficient evidence to reject the null hypothesis that the mean weights in all three channel types are the same.
