...
First, we checked the distribution of the salamander weight data. After our analysis, we discovered that the data for both sections are positively skewed. The QQ plots do not show a linear relationship, meaning that the distribution is not normal. 
